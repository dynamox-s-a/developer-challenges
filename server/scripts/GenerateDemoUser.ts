...
export async function main() {
    ...
    await createMonitoringPoint(token!, "Demo Monitoring Point 1", SensorType.TcAg, machine1Id.id);
    await createMachine(token!, "Demo Machine 2", "fan");
    await createMachine(token!, "Demo Machine 3", "fan");
}
