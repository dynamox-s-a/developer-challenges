...
//     const expirationDateObj = moment(expirationDate, "DD/MM/YYYY");
//     const manufactureDateObj = moment(manufactureDate, "DD/MM/YYYY");

//     if (
//       name.length >= MIN_LENGTH &&
//       perishable.length >= MIN_LENGTH &&
//       manufactureDateObj > expirationDateObj &&
