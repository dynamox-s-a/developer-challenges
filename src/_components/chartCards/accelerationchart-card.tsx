...
import { AcelerationChart } from "../charts/aceleration-chart";
import { AcelerationSelect } from "../charts/aceleration-select";

import ShutterSpeedIcon from '@mui/icons-material/ShutterSpeed';

export function AccelerationCardChart(){
  return(
    <>
      ...
      <Typography sx={{ display: "flex", justifyContent: 'center', alignItems: 'center', textAlign: 'center', gap: '16px', paddingBottom: { xs: '24px', md: '32px' }, fontWeight: '600', fontSize: { xs: '1rem', md: '1.5rem' } }}>
        ...
        <Box sx={{ margin: {xs: '0px 20px 0px 4px', md: '0px 48px 0px 8px'}}}>
          <AcelerationChart />
        </Box>
      </Box>
    </>
