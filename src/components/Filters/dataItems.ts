import MachineIcon from '../../assets/maquina.svg';
import LocationIcon from '../../assets/my_location_24px.svg';
import RpmIcon from '../../assets/rpm.svg';
import DynamicIcon from '../../assets/faixa_dinamica.svg';
