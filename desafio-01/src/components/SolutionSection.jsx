...
function SolutionSection() {
  return (
    <section className='flex bg-cover bg-no-repeat bg-top justify-center h-screen' style={ { backgroundImage: `url(${bgImage})`}}>
      <div className='flex flex-col justify-center mb-40 ml-10 mr-20 text-white font-raleway font-bold 2xl:text-8xl lg:text-6xl sm:text-4xl '>
        <h1 className='mb-3'>Solução</h1>
        <hi className='mb-14'>DynaPredict</hi>
        <img className='w-44 h-8 mb-28' src={logoDynaPredict} alt="Logo-DynaPredict" />
      </div>
      <div>
